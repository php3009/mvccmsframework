...
<table border="0" width="100%">
	<tr>
		<td width="50%">
			<span class="application_title">Product Manager :</span><span class="application_job">[With Attributes - Add]</span>
		</td>
		<td align="right">
		...
		<div class="TabbedPanelsContentGroup">
			<div class="TabbedPanelsContent"><br/>
				<table width="100%">
					...
					<tr>
						<td colspan="2">
							<input type="hidden" name="job" id="job" value="saveattributeproduct">
					...
					<tr>
						...
						<td>
							<span id="attributelistarea" name="attributelistarea" class="attributelist"><?php
								$this->getAttributeList($this->adminId); 
							?></span>
						</td>
					</tr>
				</table>
